...
function backgroundsetup() {
    ...
    document.getElementById('demo-body').style.background = "#94C7E4";

    document.getElementById('d-central-bg').innerHTML =  `<div id="" style="position:relative; width:100%;">
    <div class="d-central-lg" style="width:100%;"><img src="img/d-brownbg.svg" style="width: 100%;"></div>
    </div>`;
    navcontainer();
    linkactives();
}
...
function navcontainer() {
    ...
    navcontainer.style.background = "#94C7E4";
...
function linkactives() {
    ...
    kids.classList.add("nav-sup-link-active");
}
